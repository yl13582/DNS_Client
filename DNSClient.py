...
domainList  = ['cnn.com.','chase.com.','google.com.','nyu.edu.','facebook.com.']
...
def local_external_DNS_output(question_type):    
    print("Local DNS Server") #this prints the local DNS server
    for domain_name in domainList:
        ip_address = query_local_dns_server (domain_name,question_type)
        print(f"The IP address of {domain_name} is {ip_address}")


    print("\nPublic DNS Server") #this prints the public DNS server
